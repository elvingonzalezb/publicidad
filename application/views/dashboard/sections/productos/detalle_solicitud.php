        ...
        <div class="page-body">
            <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" action="dashboard/productos/responder/<?=$dataset['id']?>" method="post" id="">
                                    ...
                                    <tr>
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 p-l-15">
                                              ...
                                              <td><textarea class="form-control"  id="" name="respuesta"><?=$dataset['respuesta']?></textarea>
                                                <input type="hidden" name="producto_id" value="<?=$dataset['producto_id']?>">
                                              </td>
                                            </div>
                                        </div>
                                      </tr>
