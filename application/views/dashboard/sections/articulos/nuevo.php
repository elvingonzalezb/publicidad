<?php $this->load->view("dashboard/includes/breadcrumbs", array('titulo'=>'Nuevo Articulo')); ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body p-b-25">
                    <form class="form-horizontal" role="form" action="dashboard/articulos/nuevo" method="post" enctype="multipart/form-data" id="formArticulos">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="5" name="resumen" <?=in_array('resumen', $requerid)? 'required':''; ?>><?=( ! empty($dataset['resumen']) ? $dataset['resumen'] : '')?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <input type="number" min="1" class="form-control" value="1" id="" name="orden" placeholder="" value="" <?=in_array('orden', $requerid)? 'required':''; ?>>
