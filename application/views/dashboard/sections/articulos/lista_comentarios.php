                    ...
                    <table class="table table-striped table-hover js-exportable dataTable" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr id="fila-<?=$value['id']?>">
                                    ...
                                    <td class="center">
                                        <a class="btn btn-info" href="dashboard/articulos/editar_comentarios/<?=$value['id']?>/<?=$id_articulo?>">
                                            <i class="glyphicon glyphicon-edit icon-white"></i>
                                            Editar
                                        </a>
                                        <a class="btn btn-danger" href="javascript:eliminarItem(<?=$value['id']?>,'articulos/delete_comentario');">
