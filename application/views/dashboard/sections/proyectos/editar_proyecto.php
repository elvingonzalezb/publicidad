<!-- <div class="page-heading">
    ...
    <li class="active"><a href="dashboard/proyectos/lista_proyecto">Proyectos</a></li>
    </ol>
</div> -->
<?php $this->load->view("dashboard/includes/breadcrumbs", array('titulo'=>'Editar Proyecto')); ?>
<div class="page-body clearfix">
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Edicion del Proyecto</div>               
                <?=$this->session->flashdata('message')?>
                <div class="panel-body p-b-25">
                    <form class="form-horizontal" role="form" action="dashboard/proyectos/editar_proyecto/<?=( !empty($dataset['id']) ? $dataset['id'] : 0)?>" method="post" enctype="multipart/form-data" id="formProyectos">
