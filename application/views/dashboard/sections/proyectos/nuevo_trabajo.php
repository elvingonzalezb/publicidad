        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body p-b-25">
                    <form class="form-horizontal" role="form" action="dashboard/proyectos/nuevo_trabajo" method="post" enctype="multipart/form-data" id="formGaleriaTrabajos">                
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Proyectos</label>
                            <div class="col-sm-10">
                                <select name="proyecto_id" class="form-control chosen-select" id="sel1" data-placeholder="Seleccione Un Proyecto" <?php echo in_array('proyecto_id', $requerid)? 'required':''; ?>>
                                     <option></option>
