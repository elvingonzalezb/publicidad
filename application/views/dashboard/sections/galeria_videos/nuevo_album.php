<?php $this->load->view("dashboard/includes/breadcrumbs", array('titulo'=>'Nuevo Álbum Video')); ?>
<div class="page-body clearfix">
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Nuevo Álbum de Video</div>
                <?=$this->session->flashdata('message')?>
                <div class="panel-body p-b-25">
                    <form class="form-horizontal" role="form" action="dashboard/galeria_videos/nuevo_album" method="post" enctype="multipart/form-data" id="formGaleriaAlbumesVideos">                
