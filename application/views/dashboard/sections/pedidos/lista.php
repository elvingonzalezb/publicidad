                ...
                <tbody>
                    ...
                    <tr id="prod-<?=$value['id']?>">
                        ...
                        <!--<?php if ($value['estado'] == _C_PENDIENTE): ?>
                            <td class="center"><span class="label label-warning">Incompleto</span></td>
                            <td class="center"><? //=$value['fecha_venta']?></td>
                            <td>
                                <a class="btn btn-success" href="dashboard/pedidos/cotizar/<? //=$value['id']?>"><i class="fa fa-thumbs-up icon-white"></i> &nbsp;COTIZAR</a><br /><br />
                                <a class="btn btn-danger" href="javascript:borrarReserva(\'<? //=$value['id']?>\')"><i class="fa fa-trash icon-white"></i> &nbsp;&nbsp;BORRAR</a><br /><br />
                            </td>
                        <?php endif ?>-->
                        <?php if ($value['estado'] == _C_PAGADO): ?>
                            <td class="center"><span class="label label-success">PAGADO</span></td>
                            <td class="center"><?=$value['fecha_venta']?></td>
                            <td>
                                <a class="btn btn-info" href="dashboard/pedidos/detalle/<?=$value['id']?>"><i class="fa fa-eye icon-white"></i> VER</a><br /><br />
                                <a class="btn btn-danger" href="javascript:borrarReserva(\'<?=$value['id']?>\')"><i class="fa fa-trash icon-white"></i> &nbsp;&nbsp;BORRAR</a><br /><br />
                            </td>
                        <?php endif ?>
                    </tr>
