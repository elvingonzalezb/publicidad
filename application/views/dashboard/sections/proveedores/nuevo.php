...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="panel panel-default">
		...
		<div class="panel-body p-b-25">
		    <form class="form-horizontal" action="dashboard/proveedores/nuevo" method="post" enctype="multipart/form-data" id="formProveedor">			
				<div class="form-group">
					<label class="col-sm-2 control-label">Nombres</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="" name="nombre" placeholder="" value="" <?=in_array('nombre', $required)? 'required':''; ?>>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="" name="abreviatura" placeholder="" value="" <?=in_array('abreviatura', $required)? 'required':''; ?>>
