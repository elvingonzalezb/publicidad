...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="button" onclick="agregaPrecioLista()" value="AGREGAR STOCK">
    </div>
</div>
<div class="form-group">
            ...
            <table width="100%" cellpadding="0" border="1" cellspacing="0" id="tablaPrecios">
                ...
                ?>
                    <tr id="fila_<?=str_replace("#", "-", $value['atributos'])?>">
                        ...
                        <!-- <td align="center" valign="middle"><?=dataConfig('moneda') ?> <?php echo $value['precio'] ?></td>
                        <td align="center" valign="middle"><?=dataConfig('moneda') ?> <?php echo $value['precio_oferta'] ?></td> -->
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if(se_agrego=="1")
                {
                    ...
                    /*str += '<td align="center" valign="middle"><?=dataConfig('moneda') ?> '+precio_talla+'</td>';
                    str += '<td align="center" valign="middle"><?=dataConfig('moneda') ?> '+precio_oferta+'</td>';*/
