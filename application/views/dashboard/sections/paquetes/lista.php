                    ...
                    <table class="table table-striped table-hover js-exportable dataTable" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr id="fila-<?=$value['id']?>">
                                    ...
                                    <td><img class="img-responsive" src="files/paquetes/thumbs/<?=$value['imagen']?>" alt="<?=$value['nombre']?>"></td>
                                    <td><?=$value['nombre']?></td>
                                    <td class="center">
                                        <form action="" id="estadoAjax">
                                            ...
                                            onclick="actualizarEstado($('#idFot<?=$value['id']?>').val(),$('#estado<?=$value['id']?>').val(),'paquetes/ajaxEstado');return false;"><?=$status?></button>
                                            <span id="divResultado<?=$value['id']?>"></span>
                                        </form>
                                    </td>
                                    <td class="center">
                                        <a class="btn btn-info" href="dashboard/paquetes/editar/<?=$value['id']?>">
                                            <i class="glyphicon glyphicon-edit icon-white"></i>
                                            Editar
                                        </a>
                                        <a class="btn btn-danger" href="javascript:eliminarItem(<?=$value['id']?>,'paquetes/delete');">
