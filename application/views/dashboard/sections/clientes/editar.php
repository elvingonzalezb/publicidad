                    ...
                    <div class="panel-body p-b-25">
                        <form class="form-horizontal" role="form" action="dashboard/clientes/editar/<?=( !empty($dataset['id']) ? $dataset['id'] : 0)?>" method="post" enctype="multipart/form-data" id="formClientes">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control slugName" id="" name="ruc" placeholder="" value="<?=( ! empty($dataset['ruc']) ? $dataset['ruc'] : '')?>" onkeyup="slugUrl('slugName', 'slugUrl');" <?=in_array('ruc', $requerid)? 'required':''; ?>>
                                                    <?=form_error('ruc'); ?>
                                </div>
                            </div>               
                            <div class="form-group">
