					...
					<div class="panel panel-default">
						...
						<div class="panel-body p-b-25">
							...
							<form class="form-horizontal" action="dashboard/secciones/editar/<?=( !empty($dataset['id']) ? $dataset['id'] : 0)?>" method="post" enctype="multipart/form-data" id="formSecciones">
								...
								<?php //if(in_array('imagen', $this->inputs)): ?>
	                            ...
	                            <?php //if(in_array('nombre', $this->inputs)): ?>
								<div class="form-group">
								...
								<?php //if(in_array('descripcion', $this->inputs)): ?>
								<div class="form-group">
								...
								<?php //if(in_array('seo_title', $this->inputs)): ?>
								<div class="form-group">
								...
								<?php //if(in_array('seo_description', $this->inputs)): ?>
								<div class="form-group">
								...
								<?php //if(in_array('seo_keywords', $this->inputs)): ?>
								<div class="form-group">
