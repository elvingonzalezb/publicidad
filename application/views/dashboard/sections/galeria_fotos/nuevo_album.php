<?php $this->load->view("dashboard/includes/breadcrumbs", array('titulo'=>'Nuevo Álbum Foto')); ?>   
<div class="page-body clearfix">
    <div class="row clearfix">       
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Nuevo Álbum de Fotos</div>                
                <?= $this->session->flashdata('message')?>
                <div class="panel-body p-b-25">
                    <form class="form-horizontal" role="form" action="dashboard/galeria_fotos/nuevo_album" method="post" enctype="multipart/form-data" id="formGaleriaAlbumesFotos">   
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <textarea class="form-control" id="ckeditor" name="descripcion" placeholder="" <?=in_array('descripcion', $requerid)? 'required':''; ?>></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="" name="seo_keywords" placeholder="" value="" required>
