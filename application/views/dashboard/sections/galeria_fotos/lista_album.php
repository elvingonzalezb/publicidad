    ...
    <div class="page-body">
        <div class="panel panel-default">
                <div class="panel-heading">GALERÍA DE ÁLBUMES DE FOTOS</div>
                                ...
                                <tr id="fila-<?=$value['id']?>">
                                    ...
                                    <td class="center">
                                        <form action="" id="estadoAjax">
                                            ...
                                            onclick="actualizarEstado($('#idAlb<?=$value['id']?>').val(),$('#estado<?=$value['id']?>').val(),'galeria_fotos/ajaxEstado/<?=$value['id']?>');return false;"><?=$status?></button>
                                            <span id="divResultado<?=$value['id']?>"></span>
                                        </form>
                                    </td>
                                    <td class="center">
                                        <a class="btn btn-info" href="dashboard/galeria_fotos/editar_album/<?=$value['id']?>">
                                            <i class="glyphicon glyphicon-edit icon-white"></i>
                                            Editar
                                        </a>
                                        <a class="btn btn-danger" href="javascript:eliminarItem(<?=$value['id']?>,'galeria_fotos/delete_album');">
                                            <i class="glyphicon glyphicon-trash icon-white"></i>
                                            Borrar
                                        </a>
                                        <?php 
                                            $href = 'dashboard/galeria_fotos/lista_foto/'.$value['id'];
                                            $texto = 'Fotos';
                                        ?>
