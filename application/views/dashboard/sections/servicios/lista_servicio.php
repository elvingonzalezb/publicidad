                    ...
                    <table class="table table-striped table-hover js-exportable dataTable" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr id="fila-<?=$value['id']?>">
                                ...
                                <td><img class="img-responsive" src="files/servicios/thumbs/<?=$value['imagen']?>" alt="<?=$value['imagen_title']?>" width="300"></td>
                                <td><?=$value['nombre']?></td>
                                <td><?=$value['orden']?></td>
                                ...
                                <td class="center">
                                    <form action="" id="estadoAjax">
                                        ...
                                        <button type="button" id="btn-<?=$value['id']?>" class="btn <?=$class?>"
                                            onclick="actualizarEstado($('#idServ<?=$value['id']?>').val(),$('#estado<?=$value['id']?>').val(),'servicios/ajaxEstado');return false;"><?=$status?></button>
                                        <span id="divResultado<?=$value['id']?>"></span>
                                    </form>
                                </td>
                                <td class="center">
                                    <a class="btn btn-info" href="dashboard/servicios/editarServicio/<?=$value['id']?>/<?=$id_categoria?>">
                                        <i class="glyphicon glyphicon-edit icon-white"></i>
                                            Editar
                                    </a>
                                    <a class="btn btn-danger" href="javascript:eliminarItem(<?=$value['id']?>,'servicios/deleteServicio');">
