...
<div class="body-content outer-top-pading-bd contenido-articlo">
                    ...
                    <div class="sidebar-module-container">
                        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                            <div class="more-info-tab clearfix ">
                                <h3 class="new-product-title pull-left">Buscar Producto</h3>
                            </div>
                            <div class="sidebar-widget tm-search-widget">
                                <form id="myFormSearch" action="frontend/productos/resultado" method="get" autocomplete="off">
                                    <input class="form-control" name="search" placeholder="BUSCAR" type="text">
                                    <div class="search-btn">
                                        <a class="tm-btn btn-dark" onclick="document.getElementById('myFormSearch').submit();"></a> <span class="icon-magnifier icn"></span>
                                        <!-- <input class="tm-btn btn-dark" name="submit" type="submit" value=""> <span class="icon-magnifier icn"></span> -->
                                    </div>
                                </form>
                            </div>                     
                        </div>                
