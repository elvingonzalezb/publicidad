...
class Articulos extends CI_Controller {
  ...
  public function lista() { 
      ...
      #categorias
      $data['categorias'] = $this->Producto->getCategoriaPorTipo(1);
      $data['body'] = $seccion;
      $data['articulos']=$articulos;
      $data['recientes'] = $this->Articulos->getArticulosRecientes(5);
      $data['banner'] = getSecciones(4);
	...
	public function listaDetalle() {
      ...
      # HEADER - SEO ----------
      $data['seo'] = $articulo;
      $data['seo_fb'] = $articulo;
      $data['seo_fb']['imagen'] = base_url().'files/articulos/'.$articulo['imagen'];
      $data['seo_fb']['type'] = 'article';
      #------------------------
