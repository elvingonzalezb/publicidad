...
if ( ! function_exists('getBreadcrumbsProyectos'))
{
    ...
    function getBreadcrumbsProyectos( $titulo = array(),$id_trabajo=array(),$id_proyecto2=array() ){
		...
		if ($id == '0') { 
			...
			$html = '<li><a href="dashboard/proyectos/lista_proyecto">Proyectos</a></li>';	
			...
			if ($id_proyecto_o_trabajo == '0') { //segment 5 igual a 0	
				...
				if($nombre=='lista_trabajo'){
					...
					for ($i=0; $i < $count; $i++) { 
						...
						$html.= '<li><a href="dashboard/proyectos/lista_trabajo/'.$array2[0]['proyecto_id'].'">'.$array[0]['nombre'].'</a></li>';
					for ($j=0; $j < $count; $j++) { 
						// solo lista foto
				...
				if($nombre=='editar_trabajo'){
					// Editar Trabajo
					$html .= '<li><a href="dashboard/proyectos/lista_trabajo/'.$array3[0]['proyecto_id'].'">'.$array2[0]['nombre'].'</a></li>';
					$html.= '<li class="active"><a>'.$titulo.'</a></li>';
				} else if ($nombre=='editar_foto'){

					// Editar Foto
					$html.= '<li><a href="dashboard/proyectos/lista_trabajo/'.$array4[0]['proyecto_id'].'">'.$array5[0]['nombre'].'</a></li>';
					for ($j=0; $j < $count; $j++) { 
								
						$html .= '<li><a href="dashboard/proyectos/lista_foto/'.$id_trabajo.'">'.$array4[0]['nombre'].'</a></li>';
						$html.= '<li class="active"><a>'.$titulo.'</a></li>';
					}
		...
		if ($id == '0') {
			...
			for ($i=0; $i < $count; $i++) { 
					if ($id_album == '0') {
						...
						$html .= '<li><a href="dashboard/galeria_videos/lista_video/1">Galeria de videos</a></li>';
						$html.= '<li class="active"><a>'.$titulo.'</a></li>';
					}
			}
		}
		...
		if ($id == '0') {
			...
			for ($i=0; $i < $count; $i++) { 
					if ($id_articulo == '0') {
						...
						$html .= '<li><a href="dashboard/articulos/lista_comentarios/'.$id_articulo.'">'.$array[0]['nombre'].'</a></li>';
						$html.= '<li class="active"><a>'.$titulo.'</a></li>';
					}
			}
		}
